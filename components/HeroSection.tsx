  ...
  return (
    <div className="my-20 flex w-full flex-col items-center justify-center">
      ...
      <div className="mt-5 flex w-full max-w-sm md:max-w-lg">
        ...
        />
        <button className="relative cursor-pointer rounded-xl border border-neutral-600 px-4 py-2 dark:text-neutral-100">
      ...
      <div className="mt-20 mb-20">
        <button
          className="flex cursor-pointer items-center justify-center gap-2 rounded-[9999px] border border-neutral-600 px-4 py-2 font-medium text-neutral-600 active:scale-97 dark:border-neutral-200/20 dark:text-neutral-200"
